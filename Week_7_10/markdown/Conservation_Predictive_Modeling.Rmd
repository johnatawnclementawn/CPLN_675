...
```{r}
nPreserved <- sum(preserve$preserve)
nTotal <- nrow(preserve)

pctPreserved <- nPreserved / nTotal * 100

# Also, with the binary classification of preserve, you can run:
summary(preserve$preserve)
# and the mean indicates the pct of preserved land
```
